...
and two children nodes stored in properties called "left" and "right," 
respectively.A node is said to be a BST node if and only if it satisfies 
...
themselves or None(null) values.You are also given a target integer value; 
...
namespace EASY_02_FindClosestValueInBST
{
    class Program
    {
